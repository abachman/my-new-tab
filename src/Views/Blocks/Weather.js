        ...
        <div className='item-container'>
          ...
          <table className='temperatures'>
            <tbody>
              <tr>
                <td rowSpan='2'>
                  <div className='current-temp'>{weather.item.condition.temp}</div>
                </td>
                <td>
                  <div>&#x25b2; <span className='high-temp'>{weather.item.forecast.high}</span></div>
                </td>
              </tr>
              <tr>
                <td>
                  <div>&#x25bc; <span className='low-temp'>{weather.item.forecast.low}</span></div>
                </td>
              </tr>
            </tbody>
          </table>
...
export default GridBlockWrapper( connect(mapStateToProps, mapDispatchToProps)(Weather) )
